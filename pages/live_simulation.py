...
render_page_header(
    kicker="Interactive control laboratory",
    title="Inverted Pendulum Digital Twin",
    subtitle=(
        "Configure the nonlinear plant, controller, estimator, constraints and "
        "disturbances; then inspect the complete closed-loop response at 50 Hz."
    ),
)
...
st.sidebar.caption(
    "Parameters on this page affect only the live run. Canonical comparisons "
...
with mc4:
    st.metric("RMS Tracking Error", f"{rms_tracking:.4f} m")
